...
\begin{figure}[h]
\psfig{figure=logo.ps,height=2cm}
\end{figure}
...
\hfill {\Large\bf Licence d'Informatique}\\[-10pt]
...
{\bf{}SUJET\,:}
{\it{}Effectuez la fin de ce TD à partir de la partie 3
  (Parsing d'un programme) au niveau du parsing des deux dernières règles
  de la grammaire ({\tt{}code} \& {\tt{}expr}).}  
